...
func (r *Reconciler) validateUpdateRunStatus(ctx context.Context, updateRun *placementv1alpha1.StagedUpdateRun) (int, []*placementv1beta1.ClusterResourceBinding, []*placementv1beta1.ClusterResourceBinding, error) {
...
func (r *Reconciler) validateStagesStatus(ctx context.Context, scheduledBinding []*placementv1beta1.ClusterResourceBinding, updateRun *placementv1alpha1.StagedUpdateRun) (int, error) {
...
func validateUpdateStageStatus(existingStageStatus []placementv1alpha1.StageUpdatingStatus, updateRun *placementv1alpha1.StagedUpdateRun) (int, int, error) {
